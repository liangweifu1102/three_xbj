...
typedef struct _FactoryParamStrct_
{
    ...
    long        TrimingSiteOrign;//38   –ﬁ±ﬂ‘≠µ„
    long        TrimingDeepthOrign;//40 –ﬁ±ﬂ…Ó∂»‘≠µ„
    long        DrillSiteOrign;    //42 ◊Íø◊‘≠µ„
    long        DrillDeepthOrign;  //44 ◊Íø◊…Ó∂»‘≠µ„
...
typedef struct _UserParamStrct_
{
    ...
    unsigned short  MillingMotorStartTime; //176  œ≥µÁª˙∆Ù∂Ø ±º‰
    unsigned short  DrillMotorStartTime;//177    ◊ÍµÁª˙∆Ù∂Ø ±º‰
    ...
    unsigned short  SiteIdleSpeed;      //193 XÁ©∫
    
	unsigned short  DeepthIdleSpeed;    //194 YÁ©∫
    
	unsigned short  TrimingSpeed;       //195 xÂ∑•
 
    unsigned short  DrillFeedSpeed;     //196yÂ∑•
    
	unsigned short  MillingSpeed;       //197 zÂ∑•
 
    unsigned short  MillingRadius;      //198 ZÁ©∫
    
	unsigned short  MillingFeed;        //199 
    unsigned short  MillingFeedSpeed;   //200 ≤€«∞Ω¯∏¯ÀŸ∂» 
    unsigned short  TrimingFeedSpeed;   //201 –ﬁ±ﬂΩ¯∏¯ÀŸ∂» 
