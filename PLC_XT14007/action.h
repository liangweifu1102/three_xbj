...
typedef struct _UserParamStrct_
{
    ...
    unsigned short  xb2_one_depth;      //181 ◊Íø◊‘≠µ„
    unsigned long   xb2_all_depth;      //182 π§º˛≥§∂»
    ...
    unsigned short  xc_work_speed;    //192 œ≥µ∂«∞Ω¯µΩŒª∫Ûµ»¥˝ ±º‰
    ...
    unsigned short  drill1_radius;      //202 –ﬁ±ﬂµ∂÷±æ∂
